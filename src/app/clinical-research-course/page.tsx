...
const alumniImages = [
  "/images/Clinical Research Course/aluminni/1.png",
  "/images/Clinical Research Course/aluminni/2.png",
  "/images/Clinical Research Course/aluminni/3.png",
  "/images/Clinical Research Course/aluminni/4.png",
  "/images/Clinical Research Course/aluminni/5.png",
  "/images/Clinical Research Course/aluminni/6.png",
  "/images/Clinical Research Course/aluminni/7.png",
  "/images/Clinical Research Course/aluminni/8.png",
  "/images/Clinical Research Course/aluminni/9.png",
  "/images/Clinical Research Course/aluminni/50.png",
  "/images/Clinical Research Course/aluminni/51.png",
  "/images/Clinical Research Course/aluminni/52.png",
  "/images/Clinical Research Course/aluminni/53.png",
  "/images/Clinical Research Course/aluminni/54.png",
  "/images/Clinical Research Course/aluminni/55.png",
  "/images/Clinical Research Course/aluminni/56.png",
  "/images/Clinical Research Course/aluminni/57.png",
];
...
const OverviewContent = () => (
  <div className="flex flex-col gap-8 text-[#565656]">
    ...
    <div className="flex overflow-x-auto gap-4 pb-4" style={{ scrollbarWidth: "thin" }}>
      <iframe className="w-[320px] h-[180px] sm:w-[480px] sm:h-[270px] flex-shrink-0 rounded-lg shadow-md border-2 border-transparent hover:border-[#f58634] transition-colors" src="https://www.youtube.com/embed/D52rEuUBVTE" title="YouTube video" allowFullScreen></iframe>
      <iframe className="w-[320px] h-[180px] sm:w-[480px] sm:h-[270px] flex-shrink-0 rounded-lg shadow-md border-2 border-transparent hover:border-[#f58634] transition-colors" src="https://www.youtube.com/embed/IvtK9KAqQtE" title="YouTube video" allowFullScreen></iframe>
      <iframe className="w-[320px] h-[180px] sm:w-[480px] sm:h-[270px] flex-shrink-0 rounded-lg shadow-md border-2 border-transparent hover:border-[#f58634] transition-colors" src="https://www.youtube.com/embed/HE3vn0wAKjU?start=26" title="YouTube video" allowFullScreen></iframe>
      <iframe className="w-[320px] h-[180px] sm:w-[480px] sm:h-[270px] flex-shrink-0 rounded-lg shadow-md border-2 border-transparent hover:border-[#f58634] transition-colors" src="https://www.youtube.com/embed/TEnwpX3W-NE" title="YouTube video" allowFullScreen></iframe>
      <iframe className="w-[320px] h-[180px] sm:w-[480px] sm:h-[270px] flex-shrink-0 rounded-lg shadow-md border-2 border-transparent hover:border-[#f58634] transition-colors" src="https://www.youtube.com/embed/Ah9l5Emfyyw" title="YouTube video" allowFullScreen></iframe>
    </div>
...
const CoursesContent = () => (
  <div className="flex flex-col gap-8 text-[#565656]">
    ...
    {/* Video Gallery */}
    <div>
      <h4 className="text-2xl font-bold mb-4 font-[family-name:var(--font-libre-baskerville)] text-[#2664A8]">Student Testimonials & Discussions</h4>
...
const CareerOpportunitiesContent = () => (
  <div className="flex flex-col w-full py-8 text-[#565656] space-y-12">
    ...
    <div className="w-full flex flex-col justify-center items-center -mt-4 mb-4">
      ...
      <img src="/images/Clinical%20Research%20Course/career_opp/career_options_for_crc.png" alt="Career options for CRC" className="w-full max-w-5xl rounded-xl shadow-sm border border-gray-100" />
    </div>
    ...
    <div className="flex flex-col gap-8 items-start bg-[#f8fbfe] p-8 rounded-2xl border border-blue-100 shadow-sm text-left">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full max-w-6xl mx-auto">
      <div className="flex flex-col">
        <div className="relative pb-[56.25%] h-0 rounded-xl overflow-hidden shadow-md bg-gray-100 border border-gray-200">
          <iframe className="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/Aj0YQsmGdPU" title="Industry Video 1" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </div>
      </div>
      
      <div className="flex flex-col">
        <div className="relative pb-[56.25%] h-0 rounded-xl overflow-hidden shadow-md bg-gray-100 border border-gray-200">
          <iframe className="absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/SK5gOJbQEcc" title="Industry Video 2" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
        </div>
      </div>
